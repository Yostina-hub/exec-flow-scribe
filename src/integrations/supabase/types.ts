  ...
  public: {
    Tables: {
      ...
      advisor_conversations: {
        ...
        Relationships: [
          {
            foreignKeyName: "advisor_conversations_meeting_id_fkey"
            columns: ["meeting_id"]
            isOneToOne: false
            referencedRelation: "meetings"
            referencedColumns: ["id"]
      ...
      pending_distributions: {
        ...
        Relationships: [
          {
            foreignKeyName: "pending_distributions_meeting_id_fkey"
            columns: ["meeting_id"]
            isOneToOne: false
            referencedRelation: "meetings"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "pending_distributions_signature_request_id_fkey"
            columns: ["signature_request_id"]
            isOneToOne: false
            referencedRelation: "signature_requests"
            referencedColumns: ["id"]
        ...
        Relationships: [
          {
            ...
            columns: ["webhook_id"]
            isOneToOne: false
            referencedRelation: "distribution_webhooks"
            referencedColumns: ["id"]
          },
        ]
      }
