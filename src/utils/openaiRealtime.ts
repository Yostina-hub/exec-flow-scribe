        ...
        if (event.type === 'session.created') {
          ...
          if (this.dc && this.dc.readyState === 'open') {
            const instructions = this.sessionLanguage === 'am'
              ...
              : "You are a silent meeting transcription system for MULTILINGUAL conversations. CRITICAL INSTRUCTIONS:\n1. AUTO-DETECT the language of each utterance (Amharic, English, Arabic, or mixed)\n2. SUPPORT CODE-SWITCHING: Handle seamless transitions between languages in the same sentence\n3. ALWAYS use ORIGINAL SCRIPT: Amharic→Ge'ez (አማርኛ), Arabic→Arabic script (العربية), English→Latin\n4. NEVER romanize non-Latin scripts\n5. For Amharic: Use Ge'ez/Ethiopic (ሀ ለ ሐ መ), NOT Arabic script\n6. Identify speakers as Speaker 1, Speaker 2, etc.\n7. Preserve natural code-switching: 'Hello ሰላም how are you እንዴት ነህ' is valid\n8. DO NOT respond or speak back. Only transcribe silently.";
