        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <p class="message">
                Thank you for submitting your guest access request. We have received your 
                request for the following meeting:
              </p>
              ...
              <p class="message" style="margin-top: 30px; font-size: 14px; color: #666;">
                If you have any questions or need to update your request, please contact the meeting organizer.
              </p>
            </div>
